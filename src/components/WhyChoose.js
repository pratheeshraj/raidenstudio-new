                ...
                <div className="auto-container">
                    <div className="row wwhychoose_maindiv">
                        <div className="whychoose_left_div">
                            ...
                            <p style={{ color: "black", textAlign: "center" }}>We have a fantastic group of AI specialists who thrive on challenges and are always looking for new AI possibilities to help our clients meet their goals.</p>
                        </div>
