        ...
        <>
            ...
            <section className="faq-section three" style={{ background: "white" }}>
                <div className="auto-container">
                    <div className="row">
                        <h2 style={{ color: "black", textAlign: "center" }}>Our Tech Stack for<span style={{ color: "#00ECE5" }}> NFT Development <br /> Services</span></h2>
                        ...
                        <div className="left_Language_div">
                            <div onClick={handleFrontEnd} style={{ color: frontend ? '#00ECE5' : 'black' }}>Blockchain Networks</div>
                            <div onClick={handleMobile} style={{ color: mobile ? '#00ECE5' : 'black' }}>Storage Platforms</div>
                            <div onClick={handleBlockchain} style={{ color: blockchain ? '#00ECE5' : 'black' }}>NFT Standards</div>
                        </div>
                        {
