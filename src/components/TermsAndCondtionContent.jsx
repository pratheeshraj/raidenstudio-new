  ...
  return (
    ...
    <div className="auto-container">
      <p>
        ...
        of Raidengamezone Private Limited's Website, located at
        https://raiden.studio/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Raiden Studios if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Raiden Studios, you agreed to
        use cookies in agreement with the Raidengamezone Private Limited's
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Raidengamezone Private Limited and/or its
        licensors own the intellectual property rights for all material on
        Raiden Studios. All intellectual property rights are reserved. You may
        access this from Raiden Studios for your own personal use subjected to
      ...
      <ul     style={{
        ...
        <li>Republish material from Raiden Studios</li>
        <li>Sell, rent or sub-license material from Raiden Studios</li>
        <li>Reproduce, duplicate or copy material from Raiden Studios</li>
        <li>Redistribute content from Raiden Studios</li>
      </ul>
      ...
      <p>
        ...
        Raidengamezone Private Limited does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Raidengamezone Private Limited,its agents
        ...
        laws, Raidengamezone Private Limited shall not be liable for the
      ...
      <p>
        Raidengamezone Private Limited reserves the right to monitor all
      ...
      <p>
        You hereby grant Raidengamezone Private Limited a non-exclusive license
      ...
      <p>
        ...
        the hyperlink compensates the absence of Raidengamezone Private Limited;
      ...
      <p>
        ...
        e-mail to Raidengamezone Private Limited. Please include your name, your
      ...
      <p>
        No use of Raidengamezone Private Limited's logo or other artwork will be
...
export default TermsAndCondtionContent;
