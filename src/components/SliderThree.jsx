                        ...
                        <div className="slider-content-inner middle">
                          <div>
                            ...
                            <p className="description">
                              ...
                              services tailored to gaming businesses of any
                              size. Our team excels in NFT, Metaverse, and
                              Sports Betting design and development, delivering
                              exceptional and engaging gaming experiences.
                            </p>
                            <div className="inner-btn">
                              <div>
                                <Link className="default-btn" to="/contact">
...
>>>>>>> a49fd26385f7b658eb3dfdd1f24e64015f0114cb
                                {" "}
                                Development Partner
                              </span>
                            </h2>
                            <p className="description">
                              Utilize our expertise to fast-track your AI
                              projects with our end-to-end development services.
                              From tailored AI strategies for business growth to
                              NLP and adaptable solutions, we're your dedicated
                              AI partner.
                            </p>
                            <div className="inner-btn">
                              <div>
              ...
              <SwiperSlide>
                ...
                <div className="item-slider sliderm-height p-relative swiper-slide">
                  <div
                    className="slide-bg"
                    style={{
                      backgroundImage: "url('assets/img/bg-image/Gaming.png')",
                    }}
                  />
                  <div className="auto-container">
                    <div className="row ">
                      ...
                      <div className="col-12">
                        <div className="slider-content-inner middle">
                          <div>
                            ...
                            <p className="description">
                              Transform your business with our innovative 3D
                              Metaverse solution, merging virtual and augmented
                              technologies. Partner with VRAIDEN, a top AR and
                              VR development firm, for tailored solutions to
                              propel your VR/AR business forward.
                            </p>
                            <div className="inner-btn">
                              <div>
                                <Link className="default-btn" to="/contact">
