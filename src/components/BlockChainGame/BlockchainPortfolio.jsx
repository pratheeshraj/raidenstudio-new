    ...
    return (
        <section className="faq-section three" style={{ background: "white" }}>
            <div className="auto-container">
                <div className="row">
                    <h2 style={{ textAlign: "center", color: "black" }}>Our <span style={{ color: "#00ECE5" }}>Portfolios</span>
                    </h2>
                    ...
                    <div className='blockgame_benifit_main_div'>
                        <div className='blockgame_benifit_div'>
                            <div className='blockgame_benifit_card'>
                                <img class="img-fluid" src="/assets/img/blockchaingame/stock-photo-top-cryptocurrency-tokens-by-market-capitalization-may-arranged-on-a-surface-forming-rows-2300861397-transformed 1.jpg" alt="" />
                            ...
                            <div className='blockgame_benifit_card'>
                                <img class="img-fluid" src="/assets/img/blockchaingame/eth-ethereum-cryptocurrency-coin-exchange-blockchain-futuristic-technology-concept-generative-ai_1423-7759-transformed 1.jpg" alt="" />
                            ...
                            <div className='blockgame_benifit_card'>
                                <img class="img-fluid" src="/assets/img/blockchaingame/3d-illustration-bitcoin-bank-storage_1093524-2551-transformed 1.jpg" alt="" />
