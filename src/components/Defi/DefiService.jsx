                ...
                <div className="auto-container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-12" style={{ marginBottom: "20px", display: "flex", justifyContent: "center" }}>
                            <div class="card_metaverse" style={{ height: "100%" }}>
                                <div class="content_metaverse">
                                    <p class="heading_metaverse">DeFi dApps Development
                                    </p><p class="para_metaverse">
                                        We are a leading DeFi dApp development company that specializes in creating decentralized applications for many industries. By working with us, you can be sure that your application is secure, compliant with industry standards, and offers a flawless user experience.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12" style={{ marginBottom: "20px", display: "flex", justifyContent: "center" }}>
                            <div class="card_metaverse" style={{ height: "100%" }}>
                                <div class="content_metaverse">
                                    <p class="heading_metaverse">DeFi Exchange Development
                                    </p><p class="para_metaverse">
                                        As a premier decentralized finance development company, we are developing a cutting-edge DeFi exchange for seamless trading and management of DeFi tokens. Because our platform does not require intermediaries or centralized authority, users have complete control over their data and privacy.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card_metaverse" style={{ height: "100%" }}>
                                <div class="content_metaverse">
                                    <p class="heading_metaverse">DeFi Wallet Development
                                        ...
                                        As a leading DeFi wallet creation firm, we provide complete control over funds and data while building safe and user-friendly DeFi wallets. Providing users with independence and privacy for a seamless DeFi experience.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12" style={{ marginBottom: "20px", display: "flex", justifyContent: "center" }}>
                            <div class="card_metaverse" style={{ height: "100%" }}>
                                <div class="content_metaverse">
                                    <p class="heading_metaverse">DeFi Consulting services
                                    </p><p class="para_metaverse">
                                        DeFi consulting services provide guidance and assistance for understanding the technical environment of decentralized finance (DEFI). From planning to implementation, our services offer strategic guidance on utilizing decentralized protocols, blockchain technology, and smart contracts to generate innovative financial solutions.
                                    </p>
                                </div>
                            </div>
                        </div>
