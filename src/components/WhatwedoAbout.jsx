                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            <div
                                ...
                                data-aos-delay="300"
                            >
                                <div className="section-title-shape-one black about_what_we_do_2_div">
                                    <div className="about_what_we_do_2_image_1">
                                        <img src="\assets\img\about\consult.svg" />
                                    </div>
                                    <div>
                                        <h2 style={{ fontSize: "28px" }}>
                                            Consulting
                                ...
                                <div className="section-title-shape-one black about_what_we_do_2_div_2">
                                    <div className="about_what_we_do_2_image_2">
                                        <img src="\assets\img\about\consult.svg" />
                                    </div>
                                    <div>
                                        <h2 style={{ fontSize: "28px" }}>
