                ...
                <div className="auto-container">
                    <div className="row wwhychoose_maindiv">
                        <div className="whychoose_left_div">
                            <h2 style={{ marginBottom: "25px", color: "black", textAlign: "center" }}>Why Choose Raiden As Your AR Software and<span style={{ color: "#59C1FF" }}> App Development Company ?</span></h2>
