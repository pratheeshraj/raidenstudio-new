        ...
        >
          <div className="top">
            ...
            <form action="" onSubmit={handleSubmit} >
              ...
              <textarea type="text" placeholder="Message" value={message} onChange={(e) => setMassage(e.target.value)}
              />
              ...
              <div className="center" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                <button className="default-btn career_btn" value={"submit"} type="submit" >Submit</button>
              </div>
            </form>
          </div>
